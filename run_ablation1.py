# run_ablation1.py
# python run_ablation1.py --exp_name Proposed_Full --lambda_mi 0.0
# python run_ablation1.py --exp_name Ablation_wo_MultiTask --no_multitask --lambda_mi 0.0
# python run_ablation1.py --exp_name Ablation_wo_SSL --lambda_ssl 0.0 --lambda_mi 0.0
